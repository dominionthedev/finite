...
func TestRenderBackground(t *testing.T) {
	...
	if !strings.Contains(svg, `fill="#1a1a2e"`) {
...
func TestRenderCircle(t *testing.T) {
	...
	if !strings.Contains(svg, `fill="#a78bfa"`) {
...
func TestRenderText(t *testing.T) {
	...
	if !strings.Contains(svg, "<text") {
		t.Error("text element missing")
	}
	if !strings.Contains(svg, "finite") {
...
func TestRenderLinearGradient(t *testing.T) {
	...
	if !strings.Contains(svg, "linearGradient") {
		t.Error("linearGradient missing")
	}
}
func TestRenderRadialGradient(t *testing.T) {
	...
	if !strings.Contains(svg, "radialGradient") {
		t.Error("radialGradient missing")
	}
}
func TestRenderFilter(t *testing.T) {
	...
	if !strings.Contains(svg, "feGaussianBlur") {
		t.Error("feGaussianBlur missing")
	}
}
func TestWidget(t *testing.T) {
	...
	if !strings.Contains(svg, "#a78bfa") {
		t.Error("widget color missing")
	}
}
func TestInstanceAt(t *testing.T) {
	...
	if !strings.Contains(svg, "translate(100") {
		t.Error("translate missing")
	}
}
...
func TestAddDef(t *testing.T) {
	...
	if !strings.Contains(svg, "cf") {
		t.Error("def id missing")
	}
}
...
func TestGroup(t *testing.T) {
	...
	if !strings.Contains(svg, `id="layer-1"`) {
		t.Error("group id missing")
	}
}
