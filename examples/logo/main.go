// Logo mark — layers, path, gradient.
//
// Run: go run ./examples/logo
package main
...
func main() {
	...
	canvas.Layer("mark").Add(
		...
		draw.NewCircle(250, 250, 40, draw.Fill("#ffffff")),
	)

	canvas.Layer("type").Add(
		draw.NewText("FINITE", 250, 460,
			draw.FontSize(32),
			draw.FontWeight("900"),
